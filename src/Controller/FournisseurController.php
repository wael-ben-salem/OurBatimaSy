...
final class FournisseurController extends AbstractController{
    ...
    #[Route('/{fournisseurId}', name: 'app_fournisseur_show', methods: ['GET'])]
    ...
    #[Route('/{fournisseurId}/edit', name: 'app_fournisseur_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{fournisseurId}', name: 'app_fournisseur_delete', methods: ['POST'])]
    public function delete(Request $request, Fournisseur $fournisseur, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$fournisseur->getFournisseurId(), $request->getPayload()->getString('_token'))) {
