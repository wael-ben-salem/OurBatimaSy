...
class EquipeController extends AbstractController
{
    ...
    #[Route('/{id}/artisans', name: 'app_equipe_artisans', methods: ['GET'])]
    public function getArtisans(Equipe $equipe): Response
    {
        return $this->json([
            'artisans' => array_map(function($artisan) {
                return [
                    'id' => $artisan->getId(),
                    'nom' => $artisan->getNom(),
                    'specialite' => $artisan->getSpecialite()
                ];
            }, $equipe->getArtisan()->toArray())
        ]);
    }
}