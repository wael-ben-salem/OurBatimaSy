 ...
 */
final class Version20250419095831 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE etapeprojet CHANGE nomEtape nomEtape VARCHAR(50) NOT NULL, CHANGE description description TEXT NOT NULL, CHANGE statut statut VARCHAR(255) DEFAULT 'En attente', ADD PRIMARY KEY (Id_etapeProjet)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX Id_projet ON etapeprojet (Id_projet)
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX Id_rapport ON etapeprojet (Id_rapport)
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE etapeprojet MODIFY Id_etapeProjet INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX `primary` ON etapeprojet
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX Id_projet ON etapeprojet
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX Id_rapport ON etapeprojet
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE etapeprojet CHANGE nomEtape nomEtape VARCHAR(50) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE description description TEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE statut statut VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT 'En attente' COLLATE `utf8mb4_unicode_ci`
        SQL);
        $this->addSql(<<<'SQL'
