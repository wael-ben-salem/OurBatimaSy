 ...
 */
final class Version20250124175706 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE note CHANGE owner_id created_by_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE note CHANGE created_by_id owner_id INT DEFAULT NULL');
    }
}
